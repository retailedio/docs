---
title: "StockX Search"
api: "GET https://app.retailed.io/api/v1/scraper/stockx/search"
...
curl --location --request GET 'https://app.retailed.io/api/v1/scraper/stockx/search?query=Air Jordan Retro' \
