---
title: "Variants"
api: "GET https://app.retailed.io/api/v1/variants"
...
`https://app.retailed.io/api/v1/variants?sort=-createdAt`
...
curl --location --request GET 'https://app.retailed.io/api/v1/variants?where[or][0][and][0][id][equals]=5702016914306' \
