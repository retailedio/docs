...
<ParamField query="where[or][0][and][0][product][equals]" type="string" optional={true} placeholder="654955f65493f73e4e9d32b4">
    An example of a query parameter for the product field : `654955f65493f73e4e9d32b4`, `654955f65493f73e4e9d32b4`, etc.
</ParamField>
...
```bash Request prices by sku and filters sizes
curl --location --request GET 'https://app.retailed.io/api/v1/prices?where[or][0][and][0][product.sku][equals]=FN0598-200&where[or][0][and][0][size][in]=8,6,10' \
