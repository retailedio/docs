...
```bash Request slug
curl --location --request GET 'https://app.retailed.io/api/v1/products?where[or][0][and][0][productId][equals]=stockx-us-air-jordan-alpha-1-university-blue' \
--header 'Content-Type: application/json' \
--header 'x-api-key: <token>' \
```

```bash Request sku
curl --location --request GET 'https://app.retailed.io/api/v1/products?where[or][0][and][0][sku][equals]=392813-103' \
--header 'Content-Type: application/json' \
--header 'x-api-key: <token>' \
```

```bash Request upc or ean (relation)
curl --location --request GET 'https://app.retailed.io/api/v1/products?where[or][0][and][0][variants.id][equals]=884500475069' \
--header 'Content-Type: application/json' \
--header 'x-api-key: <token>' \
```
